...
class UserDaoTest {
    ...
    fun testRegisterAndFindUser() = runBlocking {
        val user =
            UserEntity(email = "test@example.com", password = "password123", name = "Test User", accountType = "Buyer", isAdmin = false)
    ...
    fun testLoginFlow() = runBlocking {
        ...
        val pass = "securePass"
        val user = UserEntity(email = email, password = pass, name = "Login User", accountType = "Buyer", isAdmin = false)
        userDao.insert(user)
    ...
    fun testFindByEmail() = runBlocking {
        ...
        userDao.insert(UserEntity(email = email, password = "123", name = "Find Me", accountType = "Buyer", isAdmin = false))
